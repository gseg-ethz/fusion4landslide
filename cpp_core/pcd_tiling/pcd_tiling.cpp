...
float median_point_cloud_resolution(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud)
{
...
void best_fit_plane(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud, pcl::ModelCoefficients::Ptr coefficients, float medianResolution)
{
...
void overlap_bounding_boxes(pcl::PointXYZRGB minPtCloud1, pcl::PointXYZRGB maxPtCloud1,
							pcl::PointXYZRGB minPtCloud2, pcl::PointXYZRGB maxPtCloud2,
							pcl::PointXYZRGB &overlapMin, pcl::PointXYZRGB &overlapMax,
...
void filter_based_on_bb(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudIn,
						pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudOut, 
						pcl::PointXYZRGB overlapMin, 
						pcl::PointXYZRGB overlapMax)
{
...
pcl::PointCloud<pcl::PointXYZRGB>::Ptr voxel_grid_filter(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudIn, float leafSize)
{ 
	...
	*/
	...
	{
		pcl::PointXYZRGB minPT_1 = bbMin; pcl::PointXYZRGB minPT_2 = bbMin; pcl::PointXYZRGB minPT_3 = bbMin; pcl::PointXYZRGB minPT_4 = bbMin;
		pcl::PointXYZRGB minPT_5 = bbMin; pcl::PointXYZRGB minPT_6 = bbMin; pcl::PointXYZRGB minPT_7 = bbMin; pcl::PointXYZRGB minPT_8 = bbMin;

		pcl::PointXYZRGB maxPT_1 = bbMax; pcl::PointXYZRGB maxPT_2 = bbMax; pcl::PointXYZRGB maxPT_3 = bbMax; pcl::PointXYZRGB maxPT_4 = bbMax;
		pcl::PointXYZRGB maxPT_5 = bbMax; pcl::PointXYZRGB maxPT_6 = bbMax; pcl::PointXYZRGB maxPT_7 = bbMax; pcl::PointXYZRGB maxPT_8 = bbMax;
		...
		pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudVoxelFilter1(new pcl::PointCloud<pcl::PointXYZRGB>);
		pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudVoxelFilter2(new pcl::PointCloud<pcl::PointXYZRGB>);
		pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudVoxelFilter3(new pcl::PointCloud<pcl::PointXYZRGB>);
		pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudVoxelFilter4(new pcl::PointCloud<pcl::PointXYZRGB>);
		pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudVoxelFilter5(new pcl::PointCloud<pcl::PointXYZRGB>);
		pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudVoxelFilter6(new pcl::PointCloud<pcl::PointXYZRGB>);
		pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudVoxelFilter7(new pcl::PointCloud<pcl::PointXYZRGB>);
		pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudVoxelFilter8(new pcl::PointCloud<pcl::PointXYZRGB>);
	...
	else 
	{
		...
		pcl::VoxelGrid<pcl::PointXYZRGB> vGF1;
...
void split_point_clouds_into_tiles(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudOne,
									pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudTwo,
									pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudOneOverlap,
									pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudTwoOverlap,
									pcl::PointXYZRGB bbMin,
								    pcl::PointXYZRGB bbMax,
									...
									std::string saveFilePrefix)
{
	...
	if (minNumberOfTiles == 1) 
	{
		...
		if (std::min(cloudOne->size(), cloudTwo->size()) > 1){
//		if (std::min(cloudOne->size(), cloudTwo->size()) > 1000){


//		pcl::PLYWriter writer;
//		writer.write(saveFilePrefix + "/tiled_data/non_overlap/source_tile_" + std::to_string(tileCounter) + ".ply", *cloudOne, true, false);
//		writer.write(saveFilePrefix + "/tiled_data/non_overlap/target_tile_" + std::to_string(tileCounter) + ".ply", *cloudTwo, true, false);
//
...
//		writer.write(saveFilePrefix + "/tiled_data/overlap/target_tile_" + std::to_string(tileCounter) + "_overlap.ply", *cloudTwoOverlap, true, false);
        ...
        pcl::PLYWriter writer;
		writer.write(saveFilePrefix + "/non_overlap/source_tile_" + std::to_string(tileCounter) + ".ply", *cloudOne, true, false);
		writer.write(saveFilePrefix + "/non_overlap/target_tile_" + std::to_string(tileCounter) + ".ply", *cloudTwo, true, false);

		writer.write(saveFilePrefix + "/overlap/source_tile_" + std::to_string(tileCounter) + "_overlap.ply", *cloudOneOverlap, true, false);
		writer.write(saveFilePrefix + "/overlap/target_tile_" + std::to_string(tileCounter) + "_overlap.ply", *cloudTwoOverlap, true, false);
	...
	else 
	{
		...
		if (projectionDirection == 0) 
		{
			...
			if (side_1 > side_2) 
			{
				pcl::PointXYZRGB minPT_1 = bbMin;
				pcl::PointXYZRGB minPT_2 = bbMin;
				pcl::PointXYZRGB maxPT_1 = bbMax;
				pcl::PointXYZRGB maxPT_2 = bbMax;
				
				pcl::PointXYZRGB minPT_1_overlap = bbMin;
				pcl::PointXYZRGB minPT_2_overlap = bbMin;
				pcl::PointXYZRGB maxPT_1_overlap = bbMax;
				pcl::PointXYZRGB maxPT_2_overlap = bbMax;
				...
				pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudEpoch1_1(new pcl::PointCloud<pcl::PointXYZRGB>);
				pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudEpoch2_1(new pcl::PointCloud<pcl::PointXYZRGB>);
				pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudEpoch1_1_overlap(new pcl::PointCloud<pcl::PointXYZRGB>);
				pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudEpoch2_1_overlap(new pcl::PointCloud<pcl::PointXYZRGB>);
				...
				pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudEpoch1_2(new pcl::PointCloud<pcl::PointXYZRGB>);
				pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudEpoch2_2(new pcl::PointCloud<pcl::PointXYZRGB>);
				pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudEpoch1_2_overlap(new pcl::PointCloud<pcl::PointXYZRGB>);
				pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudEpoch2_2_overlap(new pcl::PointCloud<pcl::PointXYZRGB>);
					   ...
					   bool verbose)
{
	...
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudEpoch1(new pcl::PointCloud<pcl::PointXYZRGB>);
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloudEpoch2(new pcl::PointCloud<pcl::PointXYZRGB>);

	if (verbose){std::cout << "c++: Reading point cloud data." << std::endl;}
	...
	if (is_file_exist(firstPointCloud))
	{
		...
		if (verbose){
		std::cout << "c++: Point cloud 1 read in!" << std::endl;
		std::cout << "c++: Number of Points: " << cloudEpoch1->size() << std::endl;
		}
	}
	else
	{
	...
	if (is_file_exist(secondPointCloud))
	{
		...
		std::cout << "c++: Point cloud 2 read in!" << std::endl;
		std::cout << "c++: Number of Points: " << cloudEpoch2->size() << std::endl;
		}
	}
	else
	{
...
//	std::string saveFilePrefix = tempFileName.substr(0, found);
	...
	{
	std::cout << "-----------------------------------------------------------------------------" << std::endl;
	std::cout << "c++: Starting voxel grid filter!" << std::endl;
	}

	std::string saveFilePrefix = save_dir;

//	// Create folder for saving data
//	boost::filesystem::path dstFolder_uppper = saveFilePrefix + "/tiled_data/";
//	boost::filesystem::create_directory(dstFolder_uppper);
//
//	// save non-overlap files
//	boost::filesystem::path dstFolder = saveFilePrefix + "/tiled_data/non_overlap/";
...
//	boost::filesystem::create_directory(dstFolder_overlap);
	...
	// Create folder for saving data
	boost::filesystem::path dstFolder_uppper = saveFilePrefix;
	boost::filesystem::create_directory(dstFolder_uppper);

	// save non-overlap files
	boost::filesystem::path dstFolder = saveFilePrefix + "/non_overlap/";
	boost::filesystem::create_directory(dstFolder);

    // save overlap files
	boost::filesystem::path dstFolder_overlap = saveFilePrefix + "/overlap/";
	boost::filesystem::create_directory(dstFolder_overlap);
	...
	if (voxelGridFlag){
		if (voxelGridFilterSize == 0.0) 
		{
			...
			if (verbose){std::cout << "c++: Size of the filter: " << voxelGridFilterSize << "m determined based on the median resolution!" << std::endl;}
		}
		else
			if (verbose){std::cout << "c++: Using predifend size of the filter: " << voxelGridFilterSize << "m." << std::endl;}
		...
		if (verbose)
		{
		std::cout << "c++: Point cloud one complete! " << cloudEpoch1->size() << " points remaining after voxel grid filter." << std::endl;
		}
		...
		if (verbose)
		{
		std::cout << "c++: Point cloud two complete! " << cloudEpoch2->size() << " points remaining after voxel grid filter." << std::endl;
		std::cout << "-----------------------------------------------------------------------------" << std::endl;
		}
	...
	if (verbose)
	{
	std::cout << "c++: Spliting point clouds into patches!" << std::endl;
	std::cout << "c++: Maximum number of points in a single patch: " << maxPointsPerTile << std::endl;
	std::cout << "c++: More then " << minNumberOfTiles << " patches per epoch will be generated." << std::endl;
	std::vector<std::string> projection = { "X","Y","Z" };
	std::cout << "c++: Point clouds will be projected along the " << projection[projectionDirection] << " axis." << std::endl;
	}
	
	int tileCounter = 0;

	split_point_clouds_into_tiles(cloudEpoch1, cloudEpoch2, cloudEpoch1, cloudEpoch2, bbOverlapMin, bbOverlapMax,
	maxPointsPerTile, minPointsPerTile, tileCounter, projectionDirection, overlapTiles, saveFilePrefix);

	if (verbose)
	{
	std::cout << "c++: Spliting complete. " << tileCounter << " patches saved per epoch." << std::endl;
	std::cout << "-----------------------------------------------------------------------------" << std::endl;
	}
	return true;
}
